...
- WhatsApp integrado por carta, por lista e por carrinho de compras.
...
O catálogo permite selecionar múltiplas cartas disponíveis. O carrinho fica fixo no canto inferior direito, calcula o valor total e gera uma mensagem única para WhatsApp com nome, número, coleção, idioma, condição, preço individual e total da compra.
